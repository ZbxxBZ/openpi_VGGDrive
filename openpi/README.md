...
This checkout also includes layer-wise VGGDrive CVGE geometry injection for PyTorch π0 and π0.5, with VGGT and VGGT-Omega backbones. See [README_CVGE.md](README_CVGE.md) for the architecture, setup, training, inference, and pending server validation.
